...
Det har far ni:
- 50% rabatt pa serviceavgiften - for alltid, som pilot-partner
...
Med vanlig halsning,
{{avsandare}}`,
    html:`<!DOCTYPE html><html><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><style>body{margin:0;padding:0;background:#f1f5f9}a{color:#0f172a;text-decoration:none}</style></head><body><table width="100%" cellpadding="0" cellspacing="0" style="background:#f1f5f9;padding:32px 16px"><tr><td align="center"><table width="580" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:14px;overflow:hidden;box-shadow:0 4px 16px rgba(0,0,0,0.08);max-width:580px"><tr><td style="background:linear-gradient(135deg,#0f172a 0%,#1e3a5f 100%);padding:28px 36px;text-align:center"><div style="display:inline-block;background:rgba(45,212,191,0.15);border:1px solid rgba(45,212,191,0.4);border-radius:20px;padding:5px 14px;margin-bottom:12px"><span style="color:#2dd4bf;font-size:11px;font-weight:700;letter-spacing:2px;text-transform:uppercase">BottleDROP &ndash; Ge Pant</span></div><div style="color:#ffffff;font-size:22px;font-weight:700;line-height:1.3">En enklare v&auml;g till<br>pantpengarna</div></td></tr><tr><td style="padding:36px 36px 8px"><p style="margin:0 0 20px;font-size:16px;color:#1e293b;line-height:1.6">Hej {{namn}}!</p><p style="margin:0 0 24px;font-size:15px;color:#475569;line-height:1.7">T&auml;nkte f&ouml;lja upp med lite mer om vad <strong style="color:#0f172a">BottleDROP &ndash; Ge Pant</strong> faktiskt inneb&auml;r f&ouml;r er f&ouml;rening.</p><p style="margin:0 0 28px;font-size:15px;color:#475569;line-height:1.7">Ge Pant &auml;r en digital l&ouml;sning d&auml;r era supportrar enkelt kan sk&auml;nka sin pant direkt till <strong style="color:#0f172a">{{namn}}</strong> via mobilappen &ndash; utan att ni beh&ouml;ver lyfta ett finger.</p><table width="100%" cellpadding="0" cellspacing="0" style="background:#f8fafc;border-radius:12px;border:1px solid #e2e8f0;margin-bottom:28px"><tr><td style="padding:24px 28px"><p style="margin:0 0 16px;font-size:11px;font-weight:700;color:#64748b;letter-spacing:1.5px;text-transform:uppercase">Det h&auml;r f&aring;r ni</p><table cellpadding="0" cellspacing="0" width="100%"><tr><td style="padding:10px 0;border-bottom:1px solid #e2e8f0"><table cellpadding="0" cellspacing="0"><tr><td style="width:28px;vertical-align:top"><div style="width:22px;height:22px;background:#fef9c3;border-radius:50%;text-align:center;line-height:22px;font-size:12px">&#11088;</div></td><td style="padding-left:10px;font-size:14px;color:#334155;line-height:1.5"><strong>50% rabatt p&aring; serviceavgiften &ndash; f&ouml;r alltid</strong> som pilot-partner</td></tr></table></td></tr><tr><td style="padding:10px 0;border-bottom:1px solid #e2e8f0"><table cellpadding="0" cellspacing="0"><tr><td style="width:28px;vertical-align:top"><div style="width:22px;height:22px;background:#dcfce7;border-radius:50%;text-align:center;line-height:22px;font-size:13px">&#10003;</div></td><td style="padding-left:10px;font-size:14px;color:#334155;line-height:1.5"><strong>Enkelt f&ouml;r hush&aring;llen</strong> &ndash; de donerar n&auml;r det passar dem via appen</td></tr></table></td></tr><tr><td style="padding:10px 0;border-bottom:1px solid #e2e8f0"><table cellpadding="0" cellspacing="0"><tr><td style="width:28px;vertical-align:top"><div style="width:22px;height:22px;background:#dcfce7;border-radius:50%;text-align:center;line-height:22px;font-size:13px">&#10003;</div></td><td style="padding-left:10px;font-size:14px;color:#334155;line-height:1.5"><strong>Synlighet</strong> &ndash; i BottleDROPs app och n&auml;tverk</td></tr></table></td></tr><tr><td style="padding:10px 0"><table cellpadding="0" cellspacing="0"><tr><td style="width:28px;vertical-align:top"><div style="width:22px;height:22px;background:#dcfce7;border-radius:50%;text-align:center;line-height:22px;font-size:13px">&#10003;</div></td><td style="padding-left:10px;font-size:14px;color:#334155;line-height:1.5"><strong>Kostnadsfri pilot</strong> &ndash; utan bindning</td></tr></table></td></tr></table></td></tr></table><p style="margin:0 0 28px;font-size:15px;color:#475569;line-height:1.7">Ge Pant &auml;r redan ig&aring;ng i flera regioner och vi letar nu partners i ert omr&aring;de. Svarar g&auml;rna p&aring; fr&aring;gor, eller l&auml;s mer och anm&auml;l intresse direkt:</p><table cellpadding="0" cellspacing="0" style="margin-bottom:36px"><tr><td style="background:#2dd4bf;border-radius:10px;padding:15px 32px;box-shadow:0 4px 12px rgba(45,212,191,0.35)"><a href="https://www.bottledrop.se/" style="color:#0f172a;font-size:16px;font-weight:700;text-decoration:none;white-space:nowrap">L&auml;s mer om Ge Pant &rarr;</a></td></tr></table></td></tr><tr><td style="background:#f8fafc;padding:20px 36px;border-top:1px solid #e2e8f0"><p style="margin:0;font-size:13px;color:#94a3b8;line-height:1.6">Med v&auml;nlig h&auml;lsning,<br><strong style="color:#475569">{{avsandare}}</strong></p></td></tr></table></td></tr></table></body></html>`
  },
  {
    id:"mail3",
